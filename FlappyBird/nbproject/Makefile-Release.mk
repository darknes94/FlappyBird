...
${OBJECTDIR}/EstadoGameOver.o: EstadoGameOver.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/EstadoGameOver.o EstadoGameOver.cpp
...
${OBJECTDIR}/Marcador.o: Marcador.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Marcador.o Marcador.cpp

${OBJECTDIR}/Moneda.o: Moneda.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Moneda.o Moneda.cpp
...
${OBJECTDIR}/Suelo.o: Suelo.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/Suelo.o Suelo.cpp

${OBJECTDIR}/TuberiasManager.o: TuberiasManager.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/TuberiasManager.o TuberiasManager.cpp
